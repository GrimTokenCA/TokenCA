...
contract ERC20 is Ownable, IERC20{
    ...
    constructor(string memory name_, string memory symbol_, uint256 decimals_, uint256 totalSupply_,
        address payable devWallet_, uint256 taxRate_, uint256 taxDivisionPercentage_, 
        uint256 maxTxLimit_, uint256 maxWalletLimit_){
        _name              = name_;
        _symbol            = symbol_;
        _decimals          = decimals_;
    ...
    //@dev Reflections related functionalities
